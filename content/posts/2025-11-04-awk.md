...
And you would like to get the total amount, you might be tempted to use a spreadsheet calculator but you can do it quite easily do it with awk:
...
Should you be interested in learning more one of the best resources out there is the [GNU AWK User Guide](https://www.gnu.org/software/gawk/manual/gawk.html).
